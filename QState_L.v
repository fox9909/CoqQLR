...
@WF_qstate s e (@kron  (2^(x-s)) (2^(x-s))  (2^(e-x)) (2^(e-x)) q  q').
...
Definition s_scale{s e:nat} (p:R) (st: state s e) :=
 ((fst st), (@scale (2^(e-s)) (2^(e-s)) p (snd st))).

Definition s_trace{s e:nat} (st:state s e): R:=
      Cmod (@trace (2^(e-s))  (snd st)). 
